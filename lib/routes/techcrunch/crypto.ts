...
async function handler() {
    ...
    return {
        ...
        link: host,
        description: 'Cryptocurrency coverage and news on major investments, tokens like Bitcoin and Ethereum, as well as blockchain and web3 startups that aim to build a more decentralized, community-owned future.',
        item: items,
    } as Data;
}
